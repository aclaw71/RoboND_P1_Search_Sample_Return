...
class RoverState():
    def __init__(self):
        ...
        self.start_pos = None # Set starting position
        self.terrain_ang = None # Angles of unvisited navigable terrain pixels		
        self.terrain_dists = None # Distances of unvisited navigable terrain pixels		
        self.rock_ang = None # Angles of rocks pixels		
        self.rock_dists = None # Distances of rocks pixels
